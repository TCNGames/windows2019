...
link2_status=$(curl -Is https://archive.org/download/WS2019SD/WS2019.ISO | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabotss https://archive.org/download/WS2019SD/WS2019.ISO # Windows Server 2019
if [ $link1_status = "200" ] ; then 
	...
	sudo wget -P /mediabotsshttps://archive.org/download/WS2019SD/WS2019.ISO
else
